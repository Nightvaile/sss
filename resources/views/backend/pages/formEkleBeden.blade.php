                                            ...
                                            @if(!empty($bedenler) && count($bedenler)>0)
                                                @foreach($bedenler as $beden)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span>
                                                                <a href="{{route('fDuzenleBeden',$beden->beden_ID)}}" class="mr-4" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <i class="fa fa-pencil color-muted"></i>
                                                                </a>
                                                                <a href="{{route('SilBeden',$beden->beden_ID)}}" data-toggle="tooltip" data-placement="top" title="Close">
